...
public class RegExprTests
{
    ...
    public void UrlWithTitle() { 
        ...
        Assert.Equal(new List<(string, string)>(){("/wiki/Biker-Jens" ,"biker-jens")}, results);
    }
    ...
    public void UrlWithoutTitle() { 
        ...
        var results = RegExpr.Url(html);
        Assert.Equal(new List<(string,string)>(){("/wiki/Biker-Jens", "jens romundstad")}, results);
    }
    ...
    public void UrlWithMultipleAnchors() { 
        ...
        var results = RegExpr.Url(html);
        Assert.Equal(new List<(string, string)>(){("https://en.wikipedia.org/wiki/Theoretical_computer_science", "theoretical computer science"), ("https://en.wikipedia.org/wiki/Formal_language", "formal language"), ("https://en.wikipedia.org/wiki/Character_(computing)" ,"character (computing)"), ("https://en.wikipedia.org/wiki/Pattern_matching", "pattern matching"), ("https://en.wikipedia.org/wiki/String_searching_algorithm", "string searching algorithm"), ("https://en.wikipedia.org/wiki/String_(computer_science)", "strings")}, results);
    }
